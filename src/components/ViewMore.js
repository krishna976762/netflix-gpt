...
const ViewMore = ({ onClose, movieData,openTrailer}) => {
        ...
        <div className="relative p-4 w-full max-w-2xl max-h-full">
          ...
          <div className="border-solid border-2 border-#b1acac-600 relative bg-black rounded-lg shadow dark:bg-gray-700">
            <div className="p-4 md:p-5 space-y-4 flex justify-between items-center">
              <p className="text-2xl text-white ">{movieData.original_title}</p>
              <div className="pb-4">
                <button
                  type="button"
              ...
              <div className="grid grid-cols-12 ">
                <div className="p-4 pt-0 col-span-4 flex flex-col justify-center items-center">
                  <img
                  ...
                  <button
                    ...
                    className="bg-white text-black py-1 md:py-2 px-2 md:px-9 text-xl  mt-5 rounded-lg hover:bg-opacity-50"
                  >
                    Play
                  </button>
                </div>
